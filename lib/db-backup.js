...
export function listLocalBackups() {
    const dir = getBackupDir();
    // turbopackIgnore: the backup directory is configurable at runtime, so
    // static analysis can't resolve it; without the opt-out Turbopack traces
    // the whole project (including public/) into the server output.
