...
// { user } or { error: NextResponse }. A moderated account loses the tools
// too - otherwise a sanctioned moderator could keep moderating (and lift
// their own sanction). Another moderator must lift it first.
export async function requireModerator() {
    ...
    const blocked = sanctionBlockForId(user.id);
