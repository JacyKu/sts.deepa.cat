...
// Site announcements.
//   GET  /api/v2/notifications        -> { notifications } (public)
//   POST /api/v2/notifications        -> { notification } (bot only)
//
...
// removal goes through the bot too (DELETE /api/v2/notifications/<id>).
