...
A lot of thanks to them for building and maintaining this tool for Monumenta in the first place, to [Dahlia](https://github.com/zpdh) for fixes and bringing vulnerabilities to my attention, and to [Deepacat](https://github.com/Deepacat) for new feature implementations, help and being awesome.
